...
if($iblockID == false)
{
		...
		array(
			"PRODUCT" =>
				array(
					...
					"NAME" => GetMessage("CAT_OFFER_NAME_1"),
					"ACTIVE" => "Y",
					"PROPERTY_VALUES" => array($arProps["CML2_LINK"] =>	$arElement["ID"], $arProps["327"] => $arEnumIds[0], $arProps["329"] => GetMessage("CAT_OFFER_COLOR_1"))
				),
			"PRICE" => GetMessage("CAT_OFFER_PRICE_11")
		);
	$arOfferElements[] =
		array(
			"PRODUCT" =>
				array(
					...
					"NAME" => GetMessage("CAT_OFFER_NAME_1"),
					"ACTIVE" => "Y",
					"PROPERTY_VALUES" => array($arProps["CML2_LINK"] =>	$arElement["ID"], $arProps["327"] => $arEnumIds[1], $arProps["329"] => GetMessage("CAT_OFFER_COLOR_1"))
				),
			"PRICE" => GetMessage("CAT_OFFER_PRICE_12")
		);
	...
	$arOfferElements[] =
		array(
			...
			array(
				"IBLOCK_ID" => $IBLOCK_OFFERS_ID,
				"NAME" => GetMessage("CAT_OFFER_NAME_2"),
				"ACTIVE" => "Y",
				"PROPERTY_VALUES" => array($arProps["CML2_LINK"] =>	$arElement["ID"], $arProps["327"] => $arEnumIds[2], $arProps["329"] => GetMessage("CAT_OFFER_COLOR_1"))
			),
			"PRICE" => GetMessage("CAT_OFFER_PRICE_21")
		);
	$arOfferElements[] =
		array(
			"PRODUCT" =>
			array(
				...
				"NAME" => GetMessage("CAT_OFFER_NAME_2"),
				"ACTIVE" => "Y",
				"PROPERTY_VALUES" => array($arProps["CML2_LINK"] =>	$arElement["ID"], $arProps["327"] => $arEnumIds[1], $arProps["329"] => GetMessage("CAT_OFFER_COLOR_3"))
			),
			"PRICE" => GetMessage("CAT_OFFER_PRICE_22")
		);
	$arOfferElements[] =
		array(
			"PRODUCT" =>
			...
			"PRICE" => GetMessage("CAT_OFFER_PRICE_23")
		);
	...
	foreach($arOfferElements as $key => $arOffer)
	{
		...
		$elementPrice = CPrice::Add(array("PRODUCT_ID" => $elementID, "PRICE" => $arOffer["PRICE"], "CURRENCY" => GetMessage("CURRENCY"), "CATALOG_GROUP_ID" => "1"));
	}                 
