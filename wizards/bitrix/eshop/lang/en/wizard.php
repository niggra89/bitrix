...
$MESS["WIZ_CATALOG_COMPARE"] = "Product comparison feature";
$MESS["WIZ_CATALOG_SUBSCRIBE"] = "Product notification subscription";
$MESS["WIZ_CATALOG_COUNT"] = "Products per page";
...
$MESS["WIZ_CATALOG_DETAIL_DESCR"] = "Choose the way the product specifications are displayed on the product details page";
$MESS["WIZ_CATALOG_DETAIL_DESCR_TABS"] = "Tabs";
$MESS["WIZ_CATALOG_DETAIL_DESCR_LIST"] = "List";
$MESS["WIZ_CATALOG_DETAIL_SKU"] = "Choose the user interface mode to show multiple SKU's for a product";
$MESS["WIZ_CATALOG_DETAIL_SKU_SELECT"] = "Radio buttons";
$MESS["WIZ_CATALOG_DETAIL_SKU_LIST"] = "List";
$MESS["WIZ_CATALOG_USE_IDEA"] = "Suggestions and ideas";
$MESS["WIZ_CATALOG_IDEA"] = "Enable suggestions and ideas";
...
$MESS["WIZ_CATALOG_FILTER_DESCR"] = "Provides faster access to catalog items";
$MESS["WIZ_CATALOG_COMPARE_DESCR"] = "Allows customers to view and compare parameters of multiple products in a single table";
...
$MESS["WIZ_CATALOG_DETAIL_DESCR_TABS_DESCR"] = "For products with verbose description and exhaustive information (a lot of parameters, product images etc.)";
$MESS["WIZ_CATALOG_DETAIL_DESCR_LIST_DESCR"] = "For products with little information";
$MESS["WIZ_CATALOG_DETAIL_SKU_SELECT_DESCR"] = "This option is good for customers who know exactly what they want (for example: red t-shirt size XL)";
$MESS["WIZ_CATALOG_DETAIL_SKU_LIST_DESCR"] = "This option is useful to compare all the possible product parameters";
