...
//{
	...
	{
		$arWizardDescription["STEPS"] = Array("SelectThemeStep", "SiteSettingsStep", "ShopSettings", "PersonType", "PaySystem", "DataInstallStep" ,"FinishStep");
	}
	else
	{
		$arWizardDescription["STEPS"] = Array("SelectSiteStep", "SelectThemeStep", "SiteSettingsStep", "ShopSettings", "PersonType", "PaySystem", "DataInstallStep" ,"FinishStep");
	}
/*
}
else
