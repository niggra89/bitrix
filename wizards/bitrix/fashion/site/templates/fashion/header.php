...
<div id="motto">
    <?$APPLICATION->IncludeComponent("bitrix:main.include", "", array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR."include/top_banner.php"), false);?>
</div>
...
<div id="wrapper">
    ...
    <div id="middle">
    <div id="container">
    <div id="content"<?=(CSite::inDir(SITE_DIR."catalog/") && !$isDetailPage ? '' : ' class="no-sidebar"')?>>
