...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/content/articles/index.php", array("IBLOCK.ID(XML_ID=news-articles)" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/content/articles/detail.php", array("IBLOCK.ID(XML_ID=news-articles)" => $iblockID));
?>
