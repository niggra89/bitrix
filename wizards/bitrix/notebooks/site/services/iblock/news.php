...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/content/news/index.php", array("IBLOCK.ID(XML_ID=news-news)" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/content/news/detail.php", array("IBLOCK.ID(XML_ID=news-news)" => $iblockID));
?>
