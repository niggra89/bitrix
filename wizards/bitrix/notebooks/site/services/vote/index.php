...
$arFieldsVC = array(
	...
	"SYMBOLIC_NAME"		=> "'ANKETA_".WIZARD_SITE_ID."'");
	
$rsVoteChan = CVoteChannel::GetList($by, $order, array('SYMBOLIC_NAME' => "ANKETA_".WIZARD_SITE_ID, 'SYMBOLIC_NAME_EXACT_MATCH' => 'Y'), $is_filtered);
if (!$rsVoteChan->Fetch())
{
	...
	if ($ID > 0)
	{
		...
		$arAnswers = array(
			...
			array(
				'C_SORT' => "'600'",
				'MESSAGE' => "'".$DB->ForSql(GetMessage('VOTING_INSTALL_VOTE_ANSWER1_6'))."'",
				'FIELD_TYPE' => "'0'",
				'COLOR' => "'".$DB->ForSql('#22FF00')."'",
				'QUESTION_ID' => "'$Q_ID'",
				"TIMESTAMP_X" => $DB->GetNowFunction(),
				"ACTIVE" => "'Y'",
				'FIELD_WIDTH' => "'0'",
