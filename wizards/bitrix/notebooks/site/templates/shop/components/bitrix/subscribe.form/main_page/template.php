...
<input type="text" name="sf_EMAIL" value="<?=$arResult["EMAIL"]?>" title="<?=GetMessage("subscr_form_email_title")?>" style="width:150px;"/>
</span></span> 

	</div>
	<div class="line">
		<a href="#" onclick="forms['subscribe'].submit();return false;" style="font-size:12px;" class="color_theme"><?=GetMessage("subscr_text")?></a> 
	</div>
</form>
</div>
