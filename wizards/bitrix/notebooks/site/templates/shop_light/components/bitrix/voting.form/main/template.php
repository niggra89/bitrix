...
<div class="voting-form-box">
	<form action="<?=POST_FORM_ACTION_URI?>" method="post" class="pool" name="pool">
	...
	<?foreach ($arResult["QUESTIONS"] as $arQuestion):?>
		...
		<h4 class="with_line"><?=$arQuestion["QUESTION"]?><?if($arQuestion["REQUIRED"]=="Y"){echo "<span class='starrequired'>*</span>";}?></h4>
    ...
    <? endif // CAPTCHA_CODE ?>
<a href="#" class="button" onclick="forms['pool'].submit();return false;"><span class="right"><?=GetMessage("VOTE_SUBMIT_BUTTON")?></span></a> 
