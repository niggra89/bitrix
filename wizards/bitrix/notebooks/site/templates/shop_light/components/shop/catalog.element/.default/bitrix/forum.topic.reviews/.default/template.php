...
<div class="reviews-block-container reviews-reviews-block-container">
	<div class="reviews-block-outer">
		<div class="reviews-block-inner line">
<?
$iCount = 0;
...
?>
<a href="#" class="write_review"><?=GetMessage("write_review")?></a>
<script>
$(document).ready(function(){
$('.write_review').bind('click',function(){
		if($('.reply').css('display')=='none'){
			$('.reply').css('display','block');
			$(this).html('<?=GetMessage("hide_form")?>');
		}
		else
		{
			$('.reply').css('display','none');
			$(this).html('<?=GetMessage("write_review")?>');
		}
		return false;
	});	
});
</script>
<div class="reviews-reply-form line">
