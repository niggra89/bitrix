	...
	<div class="line" >
		...
		<div class="filter_result" <?if(count($arResult["SELECTED_VALUE"])>0||($arResult["SELECTED_PRICE"]["FROM"]!=$arResult["MIN_PRICE"]||$arResult["SELECTED_PRICE"]["TO"]!=$arResult["MAX_PRICE"])){echo "style='display:block;'";}?>>
			...
			<div class="products_count line" >
				<?echo GetMessage("selected_count");?><span class="count" ><?=$arResult["ELEMENTS_COUNT"]?></span>. <a class="show" href="#" onclick="javascript:$('.filter').submit();return false;"><?echo GetMessage("filter_show");?></a> 
			</div>
			<div class="line">
				<a href="<?=$APPLICATION->GetCurPageParam("", array("filter","filter_price"))?>" class="clear_all" onclick="javascript:clearFilter();return false;"><?echo GetMessage("filter_clear");?></a>
			</div>
		</div>
