...
<?//echo "<pre>";print_r($arResult["SPECIFICATION"]);echo "</pre>";?>
					...
					<?switch($code):
						case "NAME":
							...
							if($arElement["CAN_BUY"]):
								?>
								<noindex>
								<br /><a href="<?=$arElement["BUY_URL"]?>" rel="nofollow"><?=GetMessage("CATALOG_COMPARE_BUY"); ?></a>
								</noindex>
								<?
		...
		<?foreach($arResult["SPECIFICATION"] as $spec){?>
			<?if($spec["NAME"]){?>
				<tr class="specification specification_title">
					...
					<div class="line with_line"></div><br/>
						<font style="font-size:14px;margin-left:35px;">
							<?=$spec["NAME"]?>
						</font>
					<div class="line with_line"></div>
					</td>
				</tr>
