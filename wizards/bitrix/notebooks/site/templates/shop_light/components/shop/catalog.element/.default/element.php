...
$(document).ready(function(){
	...
	$('.element_menu a').each(function(){
		if($(this).hasClass('selected'))
		{
			...
			//$('div.menu_item .'+$(this).attr('data')).css('display','block');
		}
		/*else
		{
...
<div class="line element_menu" >
	<?if($arParams["USE_SPECIFICATION"]=="Y" && $ElementID){?>
		<a href="#specification" data="specification" ><?=GetMessage('SPECIFICATION')?></a>
	<?}?>
	<?if($arParams["USE_REVIEW"]=="Y" && IsModuleInstalled("forum") && $ElementID){?>
		<a href="#reviews" data="reviews" <?if(isset($_REQUEST["MID"])){echo " class='selected' ";}?>><?=GetMessage('REVIEWS')?></a>
	<?}?>
	<?if($arParams["USE_RELATED"]=="Y" && $ElementID){?>
		<a href="#related" data="related"><?=GetMessage('RELATED')?></a>
	<?}?>
	<?if($arParams["USE_ANALOG"]=="Y" && $ElementID){?>
		<a href="#analogs" data="analogs"><?=GetMessage('ANALOG')?></a>
	<?}?>
	<br />
	<br />
	<br />
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"IBLOCK_TYPE" => $arParams["IBLOCK_SPECIFICATION_ID"],
		"SET_TITLE" => "N",
	),
	$component
);?>
...
//echo "<pre>";print_r($arResultElems);echo "</pre>";
/*--------------------------------------------------------------------------------------------------------------------------------*/
?>
</div>
<?endif?>
