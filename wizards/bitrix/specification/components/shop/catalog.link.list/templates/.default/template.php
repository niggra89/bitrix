...
<div class="link_list_analog">
<?if(count($arResult["ITEMS"])>0){?>
<p style="margin:0 0 20px 0;" class="color_theme">
	<?=GetMessage('similar')?>
	<br/>
	</p>
<?}?>
<div class="catalog_analog">
		...
		?>
		<div class="line"><a href="<?=$arElement["DETAIL_PAGE_URL"]?>"><?=$arElement["NAME"]?></a></div>
