...
{
	$arrFilterSpecification = array();
}
else
{
	global $$arParams["FILTER_SPECIFICATION_NAME"];
	$arrFilterSpecification_ = ${$arParams["FILTER_SPECIFICATION_NAME"]};
	if(!is_array($arrFilterSpecification_))
		$arrFilterSpecification_ = array();
...
*************************************************************************/
	...
	while($obElement = $rsElements->GetNextElement())
	{
		...
		if(arr_in_arr($$arParams["FILTER_SPECIFICATION_NAME"],$specification) && !in_array($arItem["ID"],$arResult["ELEMENTS"]))
		{
			if($arResult["ID"])
