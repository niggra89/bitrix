...
<?
$APPLICATION->AddHeadScript($this->GetFolder().'/jquery-1.4.3.min.js');
?>
<form action="<?=$arParams["RESULT_URL"]?>" method="POST" class="filter">
	...
	<div class="line" >
		...
		<!------------      start price slider      ------------>
			...
			<?$APPLICATION->AddHeadScript($this->GetFolder().'/jquery-ui-1.7.3.custom.min.js');
			$APPLICATION->SetAdditionalCSS($this->GetFolder()."/ui-lightness/jquery-ui-1.7.3.custom.css");?>
