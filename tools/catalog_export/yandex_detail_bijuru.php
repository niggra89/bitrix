...
IncludeModuleLangFile($_SERVER['DOCUMENT_ROOT'].'/bitrix/modules/catalog/load/yandex_detail.php');
...
$arTypesConfig = array(
	...
	'offers' => array(
		'name', 'vendor', 'vendorCode', 'sales_notes', 'manufacturer_warranty', 'country_of_origin',
	),
	'vendor.model' => array(
		'typePrefix', 'vendor', 'vendorCode', 'model', 'sales_notes', 'manufacturer_warranty', 'country_of_origin'
	),
	'my.target' => array(
		'name', 'vendor', 'vendorCode', 'model', 'manufacturer_warranty', 'country_of_origin'
	),
	'book' => array(
