...
$MESS["SEC_ANTIVIRUS_ADD"] = "Ajouter";
$MESS["SEC_ANTIVIRUS_BUTTON_OFF"] = "Désactiver Anti-Virus Web";
$MESS["SEC_ANTIVIRUS_BUTTON_ON"] = "Activer l'antivirus internet";
$MESS["SEC_ANTIVIRUS_LEVEL"] = "Il est recommandé d'activer pour un niveau élevé.";
...
$MESS["SEC_ANTIVIRUS_PARAMETERS_TAB"] = "Paramètres";
$MESS["SEC_ANTIVIRUS_PARAMETERS_TAB_TITLE"] = "Virus notification d'infection paramètres.";
$MESS["SEC_ANTIVIRUS_PREBODY_NOTFOUND"] = "Pour détecter des virus introduits avant le démarrage de la mémoire tampon de sortie, réglez le paramètre dans le fichier php.ini: <br>auto_prepend_file = #PATH#<br> ou dans.htaccess: <br>php_value auto_prepend_file '#PATH#'";
$MESS["SEC_ANTIVIRUS_PREBODY_NOTFOUND_CGI"] = "Pour détecter des virus incorporés avant le début du tamponnage de l'affichage, spécifiez le paramètre dans php.ini: <br>auto_prepend_file = #PATH#";
$MESS["SEC_ANTIVIRUS_TIMEOUT"] = "Intervalle de notification (minutes)";
$MESS["SEC_ANTIVIRUS_TITLE"] = "Antivirus-web";
$MESS["SEC_ANTIVIRUS_WARNING"] = "Les exceptions ou le mode uniquement de notification sont installées.";
$MESS["SEC_ANTIVIRUS_WHITE_LIST"] = "Exception : ";
